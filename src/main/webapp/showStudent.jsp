        ...
        <div>
            ...
            <table id="example" class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-info"><a href="update.jsp?id=<%=id%>">Edit</a></button>
                        <button class="btn btn-danger"><a href="delete.jsp?id=<%=id%>" onclick="return confirm('Are you sure ?')">Delete</a></button>
                    </td>
                </tr>
                <%}%>
                </tbody>
